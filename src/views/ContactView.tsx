...
export const ContactView: React.FC<ContactViewProps> = ({ onShowToast }) => {
  ...
  const handleSendCustomWhatsapp = (e: React.FormEvent) => {
    ...
    const greeting = trimmedName ? `Hola Carlos, soy ${trimmedName}.` : 'Hola Carlos.';
    const textToSend = trimmedMessage
      ? `${greeting} ${trimmedMessage}`
      : `${greeting} Vi tu portafolio y me gustaría conversar sobre una oportunidad.`;
    
    const finalUrl = `${baseWhatsappUrl}?text=${encodeURIComponent(textToSend)}`;
    window.open(finalUrl, '_blank', 'noopener,noreferrer');
    onShowToast('WhatsApp abierto. Revisa el mensaje antes de enviarlo.');
  };
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="p-6 sm:p-8 bg-white border border-[#e5edf5] rounded-[4px] space-y-6">
          <div className="space-y-1">
            ...
            <p className="text-[13px] text-[#50617a] font-light">
              Escribe un mensaje. Abriremos WhatsApp para que puedas revisarlo antes de enviarlo.
            </p>
          </div>

          <form onSubmit={handleSendCustomWhatsapp} className="space-y-4">
            <div className="space-y-1.5">
              <label htmlFor="sender-name" className="block text-[12px] font-medium text-[#061b31]">
              ...
              <input
                ...
                placeholder="Ej. Martín, Head of Design"
            ...
            <div className="space-y-1.5">
              <label htmlFor="contact-message" className="block text-[12px] font-medium text-[#061b31]">
              ...
              <textarea
                ...
                placeholder="Queremos conversar sobre un rol para liderar nuestro equipo de producto..."
            ...
            >
              ...
              <span>Revisar mensaje en WhatsApp</span>
            </button>
          </form>
