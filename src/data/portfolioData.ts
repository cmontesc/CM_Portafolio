...
export const PORTFOLIO_OWNER: PortfolioOwner = {
  ...
  tagline: 'UX Strategy | Product Discovery | Fintech & Health',
  ...
  status: 'Disponible para nuevos proyectos y roles Senior',
...
export const RECRUITER_METRICS: MetricItem[] = [
  {
    value: '+30%',
    label: 'Adopción en App de Salud',
...
export const FEATURED_PROJECTS: Project[] = [
  {
    ...
    category: 'mobile',
    categoryLabel: 'Mobile App & Marketplace',
    tags: ['UX Research', 'Marketplace', 'Mobile App', 'Arquetipos & Personas', 'User Flow', 'UI Kit & Prototipo', 'Figma'],
    company: 'Echomusic',
    period: '2019',
    role: 'UX / UI Designer',
    ...
    caseStudy: {
      ...
      platform: 'Mobile App (iOS / Android) & Prototipo Interactivo Figma',
      researchMethodology: [
  ...
  },
  {
    ...
    category: 'health',
    categoryLabel: 'Health & Product Design',
    tags: ['Discovery', 'UX/UI', 'Product Design', 'UX Writing', 'Workshop'],
    company: 'Isapre Esencial',
    period: '2025 — 2026',
    role: 'Product Designer',
    team: 'Product Management, UX (Carlos), Ingeniería, Negocio y Customer Experience (CX)',
    ...
    caseStudy: {
      ...
      team: 'Product Management, UX, Ingeniería, Negocio y Customer Experience (CX).',
      duration: 'Discovery → Test de usabilidad',
      platform: 'Sucursal Virtual (Escritorio y Móvil) + Matriz de Emails Transaccionales',
      researchMethodology: [
        '01. Discovery con stakeholders: Sesiones colaborativas con Product Management, UX, ingeniería, negocio y Customer Experience para identificar dolores del proceso y limitaciones técnicas, cruzadas con NPS y reclamos reales.',
      ...
      metrics: [
        {
          metric: 'Menos Reclamos',
          label: 'Reducción de Reclamos',
          description: 'Reducción esperada de reclamos asociados al proceso de licencias médicas.'
        },
        {
          metric: 'Comprensión',
          label: 'Más Comprensión',
          description: 'Mejor entendimiento del flujo completo por parte del usuario final.'
        },
        {
          metric: 'Transparencia',
          label: 'Más Transparencia',
  ...
  },
  {
    ...
    tags: ['Product Discovery', 'User Research (36 Entrevistas)', 'Arquetipos & Personas', 'Benchmark', 'Épicas & HU', 'Mobile App'],
    company: 'Santa Isabel',
    period: '2021',
    role: 'Product Designer',
    team: 'Célula UX/UI (Carlos), PO, Marketing, TI, Fulfilment, Servicio al Cliente',
    platform: 'Mobile App (iOS & Android) & Web Responsive',
  ...
  },
  {
    ...
    category: 'mobile',
    categoryLabel: 'Healthtech & Mobile',
  ...
  },
  {
    ...
    title: 'Rediseño Web End-to-End & Arquitectura SEO Schwager',
    subtitle: 'Rediseño integral del sitio web institucional de Schwager con desarrollo de plugins a medida y tableros de KPIs.',
    category: 'saas',
    categoryLabel: 'Web & Enterprise Architecture',
    tags: ['Stakeholder Interviews', 'Content Architecture', 'SEO Optimization', 'KPI Dashboards', 'WordPress'],
    company: 'Schwager SA',
    period: '2026',
    role: 'UX Engineer',
    team: 'UX Engineer (Carlos), Desarrolladores WordPress/PHP, Content & SEO Manager',
    platform: 'Plataforma Web Responsive',
    duration: '2026 (Proyecto independiente)',
    outcome: 'Arquitectura de información redefinida, plugins a medida y KPIs en tiempo real',
    summary: 'Entrevistas a stakeholders clave, estructuración de la arquitectura de contenidos, desarrollo de extensiones a medida y definición de tableros de medición de KPIs.',
    coverImage: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=1600&auto=format&fit=crop',
    aspectRatioClass: 'aspect-[16/11]',
    accentTint: '#2563eb',
    isFeaturedMarquee: true,
    caseStudy: {
      overview: 'Schwager SA requería renovar por completo su presencia digital para comunicar con solidez sus diversas líneas de negocio industriales y corporativas.',
      problem: 'El sitio web presentaba una estructura desactualizada, dificultades para que los equipos internos publicaran contenidos y nula visibilidad sobre el rendimiento del tráfico y KPIs.',
      myRole: 'Lideré el rediseño end-to-end: entrevistas a stakeholders clave, definición de la arquitectura de información, desarrollo personalizado de plugins en WordPress/PHP, mejoras en SEO y creación de tableros de KPIs.',
      team: '1 UX Engineer (Carlos), Equipo de Desarrollo Web, Stakeholders de Negocio.',
      duration: '2026',
      platform: 'Web Desktop & Mobile (WordPress / PHP / Custom Stack)',
      researchMethodology: [
        'Entrevistas individuales con directores y líderes de las unidades de negocio.',
        'Auditoría heurística de contenidos y análisis de posicionamiento SEO existente.',
        'Benchmarking de sitios corporativos industriales globales.'
      ],
      keyInsights: [
        'Los clientes corporativos necesitan acceder directamente a fichas técnicas y certificaciones en menos de dos clics.',
        'Los editores de contenido requerían un panel simplificado que evitara errores de formato.'
      ],
      designHighlights: [
        'Desarrollo personalizado de plugins para agilizar y estandarizar la publicación de noticias y servicios.',
        'Jerarquía visual moderna optimizada para indexación y posicionamiento orgánico en motores de búsqueda.',
        'Tableros de control con KPIs clave configurados para seguimiento continuo del equipo directivo.'
      ],
      metrics: [
        {
          metric: '+45%',
          label: 'Rendimiento SEO',
          description: 'Mejora en visibilidad orgánica y arquitectura semántica estructurada.'
        },
        {
          metric: '100%',
          label: 'Stakeholders Alineados',
          description: 'Integración de las necesidades de todas las divisiones corporativas en un único ecosistema.'
        }
      ]
    }
  },
  ...
  },
  {
    ...
    title: 'Optimización de Funnel de Crédito Coomeva',
    subtitle: 'Optimización del embudo digital de conversión para créditos con implementación en WordPress, HTML y CSS.',
    category: 'fintech',
    categoryLabel: 'Conversion & Fintech',
    tags: ['Funnel Optimization', 'Conversion UX', 'WordPress', 'HTML/CSS/Bootstrap'],
    company: 'Ecosistemas Digitales',
    period: '2020 — 2021',
    role: 'UX Designer',
    team: 'UX Designer (Carlos), Marketing Lead, Frontend Developer',
    platform: 'Web Responsive & Simulador',
    duration: '2020 — 2021',
    outcome: '+43% en simulaciones completadas y +12% en leads calificados',
...
export const WORK_EXPERIENCE: ExperienceItem[] = [
  ...
  },
  {
    ...
    skills: ['Mobile Health', 'Card Sorting', 'Information Architecture', 'User Flows', 'Dev Handoff']
  },
  {
    id: 'exp-twobrains',
    period: '2021 — 2024',
  ...
  },
  {
    ...
    achievements: [
      'Optimización de funnel de crédito (+43% simulaciones).',
      'Implementación en WordPress (HTML, CSS, Bootstrap).'
    ],
    skills: ['Funnel Optimization', 'Conversion UX', 'WordPress', 'HTML', 'CSS', 'Bootstrap']
  },
  {
    id: 'exp-provida',
    period: '2020 — 2021',
